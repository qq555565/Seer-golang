package gs.easing
{
   public class Elastic
   {
      ...
      public static function easeIn(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number = 0, param6:Number = 0) : Number
      {
         ...
         var _loc8_:* = param1 - 1;
         param1 -= 1;
         return -(param5 * Math.pow(2,10 * _loc8_) * Math.sin((param1 * param4 - _loc7_) * _2PI / param6)) + param2;
      }
      ...
      public static function easeInOut(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number = 0, param6:Number = 0) : Number
      {
         ...
         if(param1 < 1)
         {
            _loc8_ = param1 - 1;
            param1 -= 1;
            return -0.5 * (param5 * Math.pow(2,10 * _loc8_) * Math.sin((param1 * param4 - _loc7_) * _2PI / param6)) + param2;
         }
         _loc8_ = param1 - 1;
         param1 -= 1;
         return param5 * Math.pow(2,-10 * _loc8_) * Math.sin((param1 * param4 - _loc7_) * _2PI / param6) * 0.5 + param3 + param2;
      }
