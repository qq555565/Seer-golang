   ...
   public class NonoManager
   {
      ...
      private static function onFlyHandler(param1:SocketEvent) : void
      {
         try
         {
            ...
            if(MainManager.actorInfo != null && _loc3_ == MainManager.actorInfo.userID)
            {
               ...
               if(MainManager.actorModel != null)
               {
                  ...
                  if(_loc4_ == 0)
                  {
                     ...
                     if(MainManager.actorModel.clickMc != null)
                     {
                        MainManager.actorModel.clickMc.y = -50;
                     }
                     if(MainManager.actorModel.skeleton != null)
                     {
