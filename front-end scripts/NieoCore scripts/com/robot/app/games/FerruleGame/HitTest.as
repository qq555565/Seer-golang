package com.robot.app.games.FerruleGame
{
   ...
   public class HitTest
   {
      ...
      public static function complexHitTestObject(param1:DisplayObject, param2:DisplayObject, param3:Number = 1) : Rectangle
      {
         return complexIntersectionRectangle(param1,param2,param3);
      }
